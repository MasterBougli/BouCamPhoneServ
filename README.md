...
- a tabbed phone configuration for the local name, preferred camera, video profile, frame rate, and audio bitrate
- a fully tabbed configuration console including summary and studio shortcut panels
...
Current project version: `0.1.23`
